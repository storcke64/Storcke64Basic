...
AC_DEFUN([GB_CFLAGS_GCC_OPTION_OLD], [dnl
...
AC_DEFUN([GB_CXXFLAGS_GCC_OPTION_OLD], [dnl
...
AC_DEFUN([GB_CFLAGS_GCC_OPTION_NEW], [dnl
AS_VAR_PUSHDEF([FLAGS],[CFLAGS])dnl
...
AC_DEFUN([GB_CXXFLAGS_GCC_OPTION_NEW], [dnl
AS_VAR_PUSHDEF([FLAGS],[CXXFLAGS])dnl
...
AC_DEFUN([GB_CFLAGS_GCC_OPTION],[ifelse(m4_bregexp([$2],[-]),-1,
[GB_CFLAGS_GCC_OPTION_NEW($@)],[GB_CFLAGS_GCC_OPTION_OLD($@)])])

AC_DEFUN([GB_CXXFLAGS_GCC_OPTION],[ifelse(m4_bregexp([$2],[-]),-1,
[GB_CXXFLAGS_GCC_OPTION_NEW($@)],[GB_CXXFLAGS_GCC_OPTION_OLD($@)])])
